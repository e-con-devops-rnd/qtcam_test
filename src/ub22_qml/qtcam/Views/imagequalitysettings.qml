...
Item {
    ...
    Connections
    {
        ...
        function onImageQualitySettingsEnable(enableStatus)
        {
        ...
        function onGetBrightnessFromHID(brightnessFromHID){
            brightness_Slider.value = brightnessFromHID
        }
        function onGetContrastFromHID(contrastFromHID){
            contrast_Slider.value = contrastFromHID
        }
        function onGetSaturationFromHID(saturationFromHID){
            saturation_Slider.value = saturationFromHID
        }
        function onGetGammaFromHID(gammaFromHID){
    ...
    Connections
    {
        ...
        function onDisableAutoFocus(isAutoFocusSelected)
        {
        ...
        function onDisableAwb(isAwbSelected)
        {
    ...
    {
        target:root
        function onVideoCaptureFilterChildVisible(visibleStatus)
        {
